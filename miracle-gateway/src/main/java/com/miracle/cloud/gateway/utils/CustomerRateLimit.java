...
/**
 * @author miracle
 * created at 2019-02-07 17:49
 */
public class CustomerRateLimit  extends AbstractRateLimiter<RedisRateLimiter.Config> implements ApplicationContextAware {
    ...
    public CustomerRateLimit(ReactiveRedisTemplate<String, String> redisTemplate,
    ...
    public CustomerRateLimit(int defaultReplenishRate, int defaultBurstCapacity) {
        super(RedisRateLimiter.Config.class, CONFIGURATION_PROPERTY_NAME, null);
        this.defaultConfig = new RedisRateLimiter.Config()
    ...
    public HashMap<String, String> getHeaders(RedisRateLimiter.Config config, Long tokensLeft) {
    ...
    public static class Config {
        ...
        public CustomerRateLimit.Config setReplenishRate(int replenishRate) {
        ...
        public CustomerRateLimit.Config setBurstCapacity(int burstCapacity) {
